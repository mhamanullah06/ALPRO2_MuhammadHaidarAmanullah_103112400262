...
```
![](Modul%2012%20&%2013%20X%20Pengurutan%20Data/Output/Guided/Soal1.png)

### Penjelasan
Program ini memproses array angka dengan cara memisahkan elemen menjadi angka ganjil dan genap. Angka ganjil disimpan dan diurutkan secara menaik, sedangkan angka genap disimpan dan diurutkan secara menurun. Setelah proses pengurutan selesai, kedua array digabungkan, dimulai dari angka ganjil diikuti angka genap. Program kemudian menampilkan hasil array gabungan yang sudah terurut sesuai aturan tersebut.
...
### Penjelasan
Program ini menggunakan struct `identitas` untuk menyimpan nama dan nilai siswa. Data siswa kemudian diurutkan berdasarkan nilai ujian secara menurun menggunakan algoritma **insertion sort**. Setelah pengurutan, program mencetak nama dan nilai semua siswa yang sudah diurutkan.
...
```
![](Modul%2012%20&%2013%20X%20Pengurutan%20Data/Output/Unguided/Soal1.png)

### Penjelasan
Program ini bertujuan untuk mengurutkan nomor rumah kerabat Hercules di setiap daerah secara menaik dengan algoritma **selection sort**. Pengguna memasukkan jumlah daerah, jumlah rumah per daerah, dan daftar nomor rumah. Data disimpan dalam slice dua dimensi, lalu setiap daftar nomor rumah diurutkan menggunakan **selection sort**. Hasil akhir berupa daftar nomor rumah yang sudah terurut untuk setiap daerah ditampilkan.
...
```
![](Modul%2012%20&%2013%20X%20Pengurutan%20Data/Output/Unguided/Soal2.png)

### Penjelasan
Program ini merupakan modifikasi dari program sebelumnya, agar Hercules hanya perlu menyeberang jalan sesedikit mungkin saat mengunjungi rumah kerabatnya. Nomor rumah yang dimasukkan akan dipisah menjadi **ganjil** dan **genap**. Nomor ganjil diurutkan **menaik** dan nomor genap diurutkan **menurun** menggunakan algoritma **selection sort**. Setelah itu, hasilnya digabung dan ditampilkan per daerah: **nomor ganjil dulu**, baru **nomor genap**. Urutan ini membantu Hercules agar mengunjungi rumah-rumah di satu sisi jalan terlebih dahulu sebelum menyeberang ke sisi lainnya.
...
```
![](Modul%2012%20&%2013%20X%20Pengurutan%20Data/Output/Unguided/Soal3.png)

### Penjelasan
Program ini digunakan untuk menghitung **median** dari kumpulan bilangan bulat positif yang terus bertambah seiring input pengguna. Data disimpan selama input angka **bukan 0 atau negatif**. Jika angka **0** dimasukkan, program akan menghitung **median** dari seluruh data yang sudah ada hingga saat itu:
- Data diurutkan terlebih dahulu dengan **selection sort**.
- Jika jumlah data **ganjil**, median adalah nilai tengah.
- Jika jumlah data **genap**, median dihitung sebagai rata-rata dua nilai tengah (dibulatkan ke bawah sesuai aturan kompetisi).  
    Program akan berhenti saat memasukkan angka negatif.
Pendekatan ini memungkinkan program menghitung median **berkali-kali**, sesuai dengan permintaan input angka 0 dalam proses input data.
...
```
![](Modul%2012%20&%2013%20X%20Pengurutan%20Data/Output/Unguided/Soal4.png)

### Penjelasan
Program ini membaca deretan bilangan bulat dari input pengguna, hingga ditemukan angka negatif sebagai penanda akhir input. Selanjutnya:
- **Insertion Sort** digunakan untuk mengurutkan data secara menaik.
- Program mencetak data yang sudah terurut.
- Program memeriksa apakah **selisih antar elemen** (jarak) adalah sama.
    - Jika sama, program menyebutkan bahwa data **berjarak tetap** dan mencetak nilai jaraknya.
    - Jika berbeda, program menyatakan data **tidak berjarak tetap**.
...
```
![](Modul%2012%20&%2013%20X%20Pengurutan%20Data/Output/Unguided/Soal5.png)

### Penjelasan
Program ini mengelola daftar buku dengan informasi lengkap, seperti ID, judul, penulis, penerbit, jumlah eksemplar, tahun terbit, dan rating. Beberapa fungsi yang digunakan:
- **daftarkanBuku**: memasukkan data buku ke dalam array `DaftarBuku`.
- **urutBuku**: mengurutkan buku berdasarkan rating tertinggi menggunakan **insertion sort**.
- **cetakTerfavorit**: menampilkan buku dengan rating tertinggi.
- **cetak5Terbaru**: mencetak lima buku dengan rating tertinggi.
- **cariBuku**: mencari dan menampilkan semua buku dengan rating yang sama sesuai input pengguna.