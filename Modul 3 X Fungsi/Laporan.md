...
```
![Output](Output/Soal2.png)Ketika program dijalankan, program akan meminta pengguna untuk memasukkan tiga buah nilai input. Ketiga nilai ini kemudian diproses dengan tiga kombinasi fungsi berbeda, dan menghasilkan tiga nilai output sebagai berikut:
